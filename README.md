...
I worked on model to predict the failure of an Industrial assets.I will predict if a machine will have a failure in next 48hrs based on its everyday sensor data.
